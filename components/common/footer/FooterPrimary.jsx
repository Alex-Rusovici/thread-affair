      ...
      <div className="container footer-primary-inner">
        <nav className="footer-nav">
          ...
          <ul>
            ...
            <li>
              <Link href="/" title="Tips and tricks">
                Tips and tricks
              </Link>
            </li>
        ...
        <section className="footer-contact">
          ...
          <p>Tel:+1-877-666-1840</p>

          <a href="mailto:office@threadaffair.com">office@threadaffair.com</a>
        </section>

        <nav className="footer-support d-flex justify-content-center d-lg-flex justify-content-lg-start align-items-lg-end">
          <ul>
            <li>
